...
class Test(testlib.TestCase):
    ...
    @data(  # test-id    params    expected  timeout
            ('ts1_s',   ('small',),  ['1324812',
             '1882282', '1659373', '1675598'],   2),
            ('ts1_m',   ('medium',), ['1720392', '1694135', '1468470', '1517980', '1341550', '1595788', '1270093', '1605040', '1441484', '1744923', '1818375', '1235494', '1550419', '1686446', '1545592', '1517364', '1630594',
             '1543995', '1870113', '1907578', '1512987', '1878395', '1532154', '1845528', '1320971', '1645512', '1575805', '1932828', '1877490', '1829148', '1531581', '1454027', '1346065', '1805812', '1993350', '1288356'],   3),
            ('ts1_l',   ('large',),  ['1516973', '1378631', '1988517', '1326300', '1436970', '1482842', '1538091', '1592110', '1868602', '1317644', '1395456', '1611570', '1759846', '1589681', '1890003', '1566789', '1571440', '1532361', '1508007', '1367077', '1414035', '1654889', '1858804', '1425529', '1560128', '1748515', '1322891', '1247833', '1756575', '1528621', '1249743', '1617249', '1567501', '1675793', '1901198', '1826231', '1778183', '1968969', '1571163', '1460335', '1863275', '1411120', '1509915', '1659098', '1283397', '1485640',
             '1643763', '1839407', '1346996', '1805334', '1800103', '1517901', '1843223', '1843224', '1851787', '1632376', '1922417', '1737557', '1497197', '1239597', '1480056', '1749780', '1747280', '1313273', '1790081', '1881978', '1238022', '1854017', '1545662', '1728926', '1812601', '1367499', '1820545', '1796051', '1509254', '1281525', '1549168', '1764862', '1910532', '1626006', '1600480', '1566983', '1893339', '1650859', '1890360', '1235060', '1728506', '1694063', '1384876', '1859940', '1986254', '1970461', '1976236'],   4),
    )
    @unpack
    ...
    @data(  # test-id    params        expected           timeout
            ('pre1_s', ('1838026', 'small', 'test_pre1_s.txt'),  4,  0.5,
             'test_pre1_s.txt', (exdir+'pre1_s.expit.txt', exdir+'pre1_s.expen.txt')),
            ('pre1_m', ("1662230", 'medium', 'test_pre1_m.txt'), 15, 0.5,
             'test_pre1_m.txt', (exdir+'pre1_m.expit.txt', exdir+'pre1_m.expen.txt')),
            ('pre1_l', ('1970461', 'large', 'test_pre1_l.txt'),  4,  0.5,
             'test_pre1_l.txt', (exdir+'pre1_l.expit.txt', exdir+'pre1_l.expen.txt'))
    )
    @unpack
    ...
    @data(  # test-id    params        expected           timeout
            ('pts1_s', ('small', 'test_pts1_s.txt'),  4,  2,
             'test_pts1_s.txt', exdir+'pts1_s.expit.txt'),
            ('pts1_m', ('medium', 'test_pts1_m.txt'), 36, 3,
             'test_pts1_m.txt', exdir+'pts1_m.expit.txt'),
            ('pts1_l', ('large', 'test_pts1_l.txt'),  93, 4,
             'test_pts1_l.txt', exdir+'pts1_l.expit.txt'),
    )
    @unpack
    ...
    @data(  # test-id    params        expected           timeout
            ('per1_s', (447, 'small', 'test_per1_s.txt'),   18,  0.5,
             'test_per1_s.txt', (exdir+'per1_s.expit.txt', exdir+'per1_s.expen.txt')),
            ('per1_m', (2824, 'medium', 'test_per1_m.txt'),  19, 0.5,
             'test_per1_m.txt', (exdir+'per1_m.expit.txt', exdir+'per1_m.expen.txt')),
            ('per1_l', (4265, 'large', 'test_per1_l.txt'),  21,  0.5,
             'test_per1_l.txt', (exdir+'per1_l.expit.txt', exdir+'per1_l.expen.txt'))
    )
    @unpack
